...
//    });
    ...
    const titleChangeHandler = (event) =>{
        //console.log("expenseFormtitle " + event.target.value); //event have many properties which can be used
    ...
    const amountChangeHandler = (event) =>{
        //console.log("expenseFormAmt " + event.target.value); //event have many properties which can be used
    ...
    const dateChangeHandler = (event) =>{
        //console.log("expenseFormDate" + event.target.value); //event have many properties which can be used
    ...
    const submitHandler = (event) => {
        ...
        const expenseData = {
            title: enteredTitle,
            amount: +enteredAmount, //to convert in number 
            date: new Date(enteredDate) //string date is converted to obj
        };
        console.log("typeof amunt " + typeof(expenseData.amount));
        console.log("expenseForm is " + expenseData);

        props.onSaveExpenseData(expenseData); //its a function
